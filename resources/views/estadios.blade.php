...
@section('content')
	...
	<header>
		<h3 class="title-head">Estadios</h3>
	</header>
	@foreach($estadios as $estadio)
		<div class="fashion">
			<div class="fashion-top">
				<div class="fashion-left">
					<a href="/wiki/Ficheiro:Finale_Coupe_de_France_2010-2011_(Lille_LOSC_vs_Paris_SG_PSG).jpg"><img src="images/f1.jpg" class="img-responsive" alt=""></a>
